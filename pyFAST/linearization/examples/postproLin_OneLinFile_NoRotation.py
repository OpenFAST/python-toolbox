...
lin_file     = '../../../data/example_files/Standstill.1.lin' # Linearization file
...
for i in np.arange(nModesMax):
    ...
    print('{:3d} ,{:12.3f}, {:8.5f}       , {:7.4f},  {:s}'.format(i+1,Mode['NaturalFreq_Hz'][0],Mode['DampingRatio'][0],Mode['DampingRatio'][0]*100*2*np.pi, Desc[:min(nCharMaxDesc,len(Desc))]))
