...
def campbell_example(writeFSTfiles=True, runFAST=True, postproLin=True):
    ...
    templateFstFile     = os.path.join(scriptDir, '../../../data/NREL5MW/5MW_Land_Lin_Templates/Main_5MW_Land_Lin.fst')  # Main file, used as a template
    ...
    fastExe = os.path.join(scriptDir, '../../../data/openfast3.3_x64s.exe') # Path to a FAST exe (and dll) 
